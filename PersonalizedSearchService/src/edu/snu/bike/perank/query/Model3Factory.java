...
public class Model3Factory implements Searcher{
	private String index;
	
	public Model3Factory(String index){
	this.index	= index;
	...
	public Integer getNumberOfHits(QueryInput input) throws IOException, ParseException {
		...
		ScoreDoc[] results = multisearcher.search(QueryModel
				.getWeightDesignatatedPreferenceQuery(standarquery, input.getPreferenceMap()),
