...
public class Model1Factory implements Searcher{
	
private String index;
	
	public Model1Factory(String index){
	this.index	= index;
	...
	public Integer getNumberOfHits(QueryInput input) throws Exception {
		...
		ScoreDoc[] results = multisearcher.search(QueryModel.getNormalizedQuery(standarquery)
