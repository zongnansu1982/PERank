...
public class TopicInterestTable implements java.io.Serializable {
	...
	/** default constructor */
	public TopicInterestTable() {
	}

	/** minimal constructor */
	public TopicInterestTable(String topic) {
		this.topic = topic;
	}

	/** full constructor */
	public TopicInterestTable(String topic, Set preferencetopicmappings) {
		this.topic = topic;
